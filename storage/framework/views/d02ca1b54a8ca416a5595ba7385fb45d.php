<section style="margin-bottom: 1.5rem;">
    ...
    <div id="confirm-user-deletion" style="display: none;">
        <form method="post" action="<?php echo e(route('profile.destroy')); ?>" style="padding: 1.5rem;">
            <?php echo csrf_field(); ?>
...
</section><?php /**PATH C:\Users\Suneel Kumar\Desktop\cartrabbit\Bike\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>