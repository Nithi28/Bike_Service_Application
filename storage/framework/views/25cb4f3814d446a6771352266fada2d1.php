...
<style>
    body {
        background-image: url("<?php echo e(asset('images/t.jpg')); ?>");
...
<div class="flex-container">
    ...
    <h2><a href="<?php echo e(route('contact')); ?>" id="contact">Contact Us</a></h2>

    

    <a href="<?php echo e(route('service.create')); ?>" class="btn btn-bottom">Book Now</a>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.template2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Suneel Kumar\Desktop\cartrabbit\Bike\resources\views/dashboard.blade.php ENDPATH**/ ?>